  ...
  <div class="bg-white">
    ...
    <main class="h-full">
      ...
      <div class="relative isolate overflow-hidden bg-gray-900 pb-16 pt-14 sm:pb-20">
        <img src="/images/pexels-hakeem-james-hausley-13148635.jpg" alt="" class="absolute inset-0 -z-10 h-full w-full object-cover" />
        ...
        <div class="mx-auto max-w-7xl px-6 lg:px-8">
          <div class="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
            <div class="text-center">
              <h1 class="text-4xl font-bold tracking-tight text-white sm:text-6xl">Explore the Maldives</h1>
              <div class="mt-10 flex items-center justify-center gap-x-6">
                <a href="#" class="rounded-md bg-cyan-600 px-3.5 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-cyan-700 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-cyan-700">Get Started</a>
                <a href="#" class="text-sm font-semibold leading-6 text-black">Contact Us<span aria-hidden="true">→</span></a>
              </div>
            </div>
          </div>
        </div>
